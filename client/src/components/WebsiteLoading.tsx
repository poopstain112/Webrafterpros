...
export const WebsiteLoading: React.FC = () => {
  return (
    <div className="flex-1 flex items-center justify-center">
      <div className="text-center p-8 max-w-md mx-auto bg-white rounded-xl shadow-lg">
        ...
        <p className="text-gray-600 mb-6 text-lg">We're building a professional website that typically takes 30-60 seconds to generate.</p>
        ...
        <div className="text-sm text-gray-500 space-y-2 border-t border-gray-100 pt-4">
          ...
          <p className="animate-pulse" style={{animationDelay: '0.5s'}}>Creating responsive layouts for all screen sizes...</p>
          <p className="animate-pulse" style={{animationDelay: '1s'}}>Generating professional content for your business...</p>
        </div>
      </div>
    </div>
  );
