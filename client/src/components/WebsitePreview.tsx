...
<body>
  ...
  return (
    <div className={`${isStandalone ? '' : 'fixed inset-0 bg-black/50 z-50'} flex flex-col h-full`}>
      ...
      <Dialog open={isSectionEditMode} onOpenChange={setIsSectionEditMode}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>Edit {activeSectionName} Section</DialogTitle>
          </DialogHeader>
          <div className="py-4">
            <p className="text-sm text-gray-600 mb-4">
              Choose one of the design options below for your {activeSectionName} section:
            </p>
            
            <div className="grid gap-4">
              <div 
                className="border rounded-lg p-4 hover:border-blue-500 cursor-pointer transition-all flex items-center" 
                onClick={() => handleSectionOptionSelect(activeSectionName || '', 0)}
              >
              ...
              <div 
                className="border rounded-lg p-4 hover:border-blue-500 cursor-pointer transition-all flex items-center" 
                onClick={() => handleSectionOptionSelect(activeSectionName || '', 1)}
              >
                <div className="w-12 h-12 bg-blue-100 flex items-center justify-center rounded-full mr-4">
              ...
              <div 
                className="border rounded-lg p-4 hover:border-blue-500 cursor-pointer transition-all flex items-center" 
                onClick={() => handleSectionOptionSelect(activeSectionName || '', 2)}
              >
                <div className="w-12 h-12 bg-blue-100 flex items-center justify-center rounded-full mr-4">
